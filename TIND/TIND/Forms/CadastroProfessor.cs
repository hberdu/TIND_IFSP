...
namespace TIND.Forms
{
    public partial class CadastroProfessor : Form
    {
        ...
        public void exibirDadosProfessor(int id, string nome)
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_SelecionarProfessor", conexao.conexao);
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (operador == 1)
            {
                ...
                SqlCommand cmd = new SqlCommand("SP_InserirProfessor", conexao.conexao);
                cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                SqlCommand cmd2 = new SqlCommand("SP_AtualizarProfessor", conexao.conexao);
                cmd2.CommandType = CommandType.StoredProcedure;
                cmd2.Parameters.AddWithValue("@NOME", txtNome.Text);
                cmd2.Parameters.AddWithValue("@PRONTUARIO", txtProntuario.Text);
                cmd2.Parameters.AddWithValue("@EMAIL", txtEmail.Text);
                cmd2.Parameters.AddWithValue("@ID", Idprofessor);
